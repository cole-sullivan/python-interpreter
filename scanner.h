...
typedef enum {
	...
	TOKEN_AWAIT, TOKEN_BREAK, TOKEN_CLASS,
	TOKEN_CONTINUE, TOKEN_DEF, TOKEN_DEL, TOKEN_ELIF,
	TOKEN_ELSE, TOKEN_EXCEPT, TOKEN_FINALLY, 
	TOKEN_FOR, TOKEN_FROM, TOKEN_GLOBAL, TOKEN_IF,
	TOKEN_IMPORT, TOKEN_IN, TOKEN_IS, TOKEN_LAMBDA,
	TOKEN_NONLOCAL, TOKEN_NOT, TOKEN_OR, TOKEN_PASS,
	TOKEN_RAISE, TOKEN_RETURN, TOKEN_TRY,
	TOKEN_WHILE, TOKEN_WITH, TOKEN_YIELD,
	TOKEN_FALSE, TOKEN_NONE, TOKEN_TRUE,
